		...
		<div>
			<div class="rt-button1">
				...
				<cfif variables.totalStopcount neq stopNumber>
					<a href="javascript:void(0);"><img src="images/upButton.png"  style="position:absolute;margin-left: 60px;margin-top: 4px;" title="By clicking this  stop #(stopNumber-1)# and stop #stopNumber# get swaped " onclick="return stopInterChanging('up','#url.loadid#','#application.dsn#',#(stopNumber-1)#);"></a>
					<a href="javascript:void(0);"><img src="images/upButton.png" style="position:absolute;margin-top: 4px;
    margin-left: 94px; -ms-transform: rotate(180deg);-webkit-transform: rotate(180deg);transform: rotate(180deg);" title="By clicking this stop #(stopNumber)#  and stop #(stopNumber+1)#  get swaped " onclick="return stopInterChanging('down','#url.loadid#','#application.dsn#',#(stopNumber-1)#);"></a>
				<cfelse>
					<a href="javascript:void(0);"><img src="images/upButton.png"  style="position:absolute;margin-left: -56px;margin-top: 33px;" title="By clicking this  stop #(stopNumber-1)#  and stop #(stopNumber)#  get swaped " onclick="return stopInterChanging('up','#url.loadid#','#application.dsn#',#(stopNumber-1)#);"></a>
				</cfif>
			</div>
			<div class="clear"></div>
        ...
        <fieldset>
			...
			<div style="width:100%" class="carrierrightdiv">
				...
				<div style="width:200px;float:left;position: relative;">
					...
					<input name="userDef1#stopNumber#" value="#request.LoadStopInfoShipper.userDef1#" type="text" tabindex="#evaluate(currentTab++)#" class="carriertextbox userOnchageUpdate" data-loadid="#url.loadid#"  data-stopNumber="#stopNumber#" data-inputname="userDef1"/>
			...
			<div style="width:100%" class="carrierrightdiv">
				...
				<div style="width:200px;float:left;position: relative;">
					...
					<input name="userDef2#stopNumber#" value="#request.LoadStopInfoShipper.userDef2#" type="text" tabindex="#evaluate(currentTab++)#" class="carriertextbox userOnchageUpdate" data-loadid="#url.loadid#"  data-stopNumber="#stopNumber#" data-inputname="userDef2"/>
			...
			<div style="width:100%" class="carrierrightdiv">
				...
				<div style="width:200px;float:left;position: relative;">
					...
					<input name="userDef3#stopNumber#" value="#request.LoadStopInfoShipper.userDef3#" type="text" tabindex="#evaluate(currentTab++)#" class="carriertextbox userOnchageUpdate" data-loadid="#url.loadid#"  data-stopNumber="#stopNumber#" data-inputname="userDef3"/>
			...
			<div style="width:100%" class="carrierrightdiv">
				...
				<div style="width:200px;float:left;position: relative;">
					...
					<input name="userDef4#stopNumber#" value="#request.LoadStopInfoShipper.userDef4#" type="text" tabindex="#evaluate(currentTab++)#" class="carriertextbox userOnchageUpdate" data-loadid="#url.loadid#"  data-stopNumber="#stopNumber#" data-inputname="userDef4"/>
			...
			<div style="width:100%" class="carrierrightdiv">
				...
				<div style="width:200px;float:left;position: relative;">
					...
					<input name="userDef5#stopNumber#" value="#request.LoadStopInfoShipper.userDef5#" type="text" tabindex="#evaluate(currentTab++)#" class="carriertextbox userOnchageUpdate" data-loadid="#url.loadid#"  data-stopNumber="#stopNumber#" data-inputname="userDef5"/>
			...
			<div style="width:100%" class="carrierrightdiv">
				...
				<div style="width:200px;float:left;">
					...
					<input name="userDef6#stopNumber#" value="#request.LoadStopInfoShipper.userDef6#" type="text" tabindex="#evaluate(currentTab++)#" class="carriertextbox userOnchageUpdate" data-loadid="#url.loadid#"  data-stopNumber="#stopNumber#" data-inputname="userDef6"/>
          ...
          <tbody>
			...
			<cfloop query="request.qItems">
                <tr <cfif request.qItems.currentRow mod 2 eq 0>bgcolor="##FFFFFF"<cfelse>  bgcolor="##f7f7f7"</cfif> id="commodities#stopNumber#_#request.qItems.currentRow#">
                  ...
                  <td class="normaltdC" valign="middle" align="left"><input name="description#stopNumber#_#request.qItems.currentRow#" id="description_#request.qItems.currentRow#" class="t-textbox" value="#replace(request.qItems.description,'"','&quot;','all')#" type="text" tabindex="#evaluate(currentTab+1)#" <cfif not request.qSystemSetupOptions.commodityWeight> style="width:220px;" </cfif> /></td>
				  <cfif request.qSystemSetupOptions.commodityWeight>
                  ...
                  <td class="normaltdC" valign="middle" align="left"><select name="class#stopNumber#_#request.qItems.currentRow#" id="class#stopNumber#_#request.qItems.currentRow#" class="t-select" tabindex="#evaluate(currentTab+1)#" style="width:60px;" >
                      <option></option>
				  ...
				  <td class="normaltdC" valign="middle" align="left"><input name="CustomerRate#stopNumber#_#request.qItems.currentRow#" id="CustomerRate#stopNumber#_#request.qItems.currentRow#" onChange="CalculateTotal('#Application.dsn#');formatDollar(this.value, this.id);" class="q-textbox CustomerRate" value="#myCurrencyFormatter(variables.CustomerRate)#"  type="text" tabindex="#evaluate(currentTab+1)#"/></td>
                  <td class="normaltd2C" valign="middle" align="left"><input name="CarrierRate#stopNumber#_#request.qItems.currentRow#" id="CarrierRate#stopNumber#_#request.qItems.currentRow#" onChange="CalculateTotal('#Application.dsn#');formatDollar(this.value, this.id);" class="q-textbox CarrierRate" value="#myCurrencyFormatter(variables.CarrierRate)#"  type="text" tabindex="#evaluate(currentTab+1)#" /></td>
             ...
             <!---  <cfif request.qItems.recordcount lt 7>
              ...
              <cfloop from ="1" to="1" index="rowNum">
                <tr <cfif rowNum mod 2 eq 0>bgcolor="##FFFFFF"<cfelse>  bgcolor="##f7f7f7"</cfif> >
                  ...
                  <td class="normaltdC" valign="middle" align="left"><select name="unit#stopNumber#_#rowNum#" id="unit#stopNumber#_#rowNum#" class="unit t-select" onchange="changeQuantityWithtype(this,#stopNumber#);checkForFee(this.value,'#rowNum#','#stopNumber#','#application.dsn#')" tabindex="#evaluate(currentTab+1)#">
                      <option value=""></option>
                      <cfloop query="request.qUnits">
                        <option value="#request.qUnits.unitID#">#request.qUnits.unitName#<cfif trim(request.qUnits.unitCode) neq ''>(#request.qUnits.unitCode#)</cfif></option>
                      </cfloop>
                    </select></td>
                  <td class="normaltdC" valign="middle" align="left"><input name="description#stopNumber#_#rowNum#" id="description#stopNumber#_#rowNum#" class="t-textbox" type="text" tabindex="#evaluate(currentTab+1)#" <cfif request.qSystemSetupOptions.commodityWeight> width="30%"<cfelse> width="71%" </cfif>/></td>
				  <cfif request.qSystemSetupOptions.commodityWeight>
