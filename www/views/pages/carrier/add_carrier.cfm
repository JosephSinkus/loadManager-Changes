...
<cfoutput>
	...
	<cfparam name="isShowDollar" default="">
...
<cfelse>
	...
	<cfif isdefined('url.mcNo') and len(url.mcNo) gt 1>
   		<!--- Since carrierid doesnot exists so here make a webservice call --->
			...
			<cfelse>
				<cfinclude template="websiteDATACarrier.cfm">
			</cfif>
		<!--- end --->
					 ...
					 <cfinput type="hidden" id="SaferWatch" name="SaferWatch" value="#val(request.qGetSystemSetupOptions.SaferWatch)#">
						<div class="form-con">
							<fieldset class="carrierFields">
                                <label>MC ##</label>
								<cfif requireValidMCNumber EQ True>
								  <cfinput name="MCNumber" id="MCNumber" type="text" tabindex="1"  value="#MCNumber#"  required="yes" message="Please enter MC Number"/>
								<cfelse>
                      		    ...
                      		    <cfif structkeyexists(url,"DOTNumber")>
                      		    	<cfinput name="DOTNumber" id="DOTNumber" type="text" value="#Dotnumber#"/>
                      		    <cfelse>
									<cfinput name="DOTNumber" id="DOTNumber" type="text" value="#DOTNumber#"/>
                      		    </cfif>
...
<option value="#request.qstates.StateCode#" <cfif ucase(request.qstates.StateCode) eq #ucase(StateValCODE)#> selected="true"</cfif>>#request.qstates.statecode#</option>
							...
							<select name="Country" tabindex="8">
                                   ...
                                   <cfloop query="request.qCountries">
                                       <option value="#request.qCountries.CountryID#" <cfif request.qCountries.CountryID is Country1 OR request.qCountries.COUNTRYCODE EQ Country1> selected="true"</cfif>>#request.qCountries.Country#</option>
                                   </cfloop>
							</select>
							<div class="clear"></div>
							<label>Phone*</label>
							<cfinput name="Phone" tabindex="9" type="text" value="#Phone#" required="yes" message="Please enter Phone Number." onchange="ParseUSNumber(this,"");" style="width:122px;"/>
							...
							<div class="clear"></div>
                               ...
                               <label style="width:70px;">Equip</label>
                                   <select name="equipment" tabindex="17" style="width:106px;">
                                     ...
                                     <option value="#request.qEquipments.equipmentId#" <cfif equipment is request.qEquipments.equipmentId> selected="true" </cfif>>#request.qEquipments.equipmentName#</option>
									</cfloop>
                                 </select>
                               <div class="clear"></div>
                               <label class="FedTaxId">Fed Tax ID</label>
                                ...
                                <cfif isdefined('url.CarrierId') and len(url.carrierId) GT 1 AND (request.qCarrier.AYBImport EQ true) >
                                	<cfinput name="venderId" type="text" tabindex="18" value="#vendorID#" readonly>
                                <cfelse>
                                	<cfinput name="venderId" type="text" value="#vendorID#" tabindex="18"  />
									<cfinput name="venderId" type="text" style="display:none;">
                                </cfif>
								<div class="clear"></div>
								<label>Mobile App Password</label>
								 <cfinput name="MobileAppPassword" type="password"  style="display:none;">
								 <cfinput name="MobileAppPassword" type="password" tabindex="18" value="#MobileAppPassword#" style="width:126px;">

								 <input type="checkbox" name="isShowDollar" class="small_chk myElements" style="margin-right: 16px !important;" <cfif len(isShowDollar) AND isShowDollar EQ 1>checked="checked"</cfif>>
								 <label style="float:right;">Show Dollar($)</label>
						...
						<fieldset class="carrierFields">
							...
							<cfselect name="RemitState" id="RemitState" tabindex="21" style="width:96px;">
								<option value="">Select</option>
								<cfloop query="request.qstates">
									<option value="#request.qstates.statecode#" <cfif  request.qstates.statecode is RemitState> selected="true" </cfif>>#request.qstates.statecode#</option>
							   </cfloop>
						   </cfselect>
							<div class="clear"></div>
							...
							<cfinput name="RemitContact" tabindex="23" type="text" value="#RemitContact#"  style="width:90px;"/>
							<div class="clear"></div>
							<label>Remit Phone</label>
							<cfinput name="RemitPhone" tabindex="24" type="text" value="#RemitPhone#" style="width:90px" onchange="ParseUSNumber(this,'Remit Phone');"/>
							<label style="width:77px;">Remit Fax</label>
							<cfinput name="RemitFax" type="text" tabindex="25" value="#RemitFax#" style="width:90px;" onchange="ParseUSNumber(this,'Remit Fax');"/>
							<div class="clear"></div>
							...
							<div class="clear"></div>
							<cfinput name="InsCompany" tabindex="26" type="text" value="#InsCompany#" style="width:274px;margin-left:10px;"/>
							<cfinput name="InsComPhone" tabindex="27" type="text" value="#trim(InsComPhone)#" onchange="ParseUSNumber(this,"");" style="width:90px;"/>
							<div class="clear"></div>
							<label style="width:281px;text-align:left;padding-left:10px;">Agent</label>
							<label style="text-align:left;">Agent Phone</label>
							<div class="clear"></div>
							<cfinput name="InsAgent" id="InsAgent" tabindex="28" type="text" value="#trim(InsAgent)#" style="width:274px;margin-left:10px;"/>
							...
							<div class="clear"></div>
							<textarea name="InsuranceCompanyAddress" id="InsuranceCompanyAddress" class="textBoxCarrierInsurance" placeholder="Company Address" rows="4">#InsuranceCompanyAddress#</textarea>
							<div class="clear"></div>
							<label>Policy ##</label>
							...
							<cfif isdate(InsExpDate)>
								<cfinput name="InsExpDate" tabindex="31" type="datefield" value="#Dateformat(InsExpDate,'mm/dd/yyyy')#" style="width:64px" onblur="checkDateFormatAll(this);"/>
							<cfelse>
								<cfinput name="InsExpDate" tabindex="31" type="datefield" value="" style="width:64px" onblur="checkDateFormatAll(this);"/>
							</cfif>

							<div class="clear"></div>
							<label>Insurance Limit</label>
							<input type="text" name="InsLimit" tabindex="32" value="#DollarFormat(InsLimit)#"  style="width:79px;text-align: right;">
							<label style="width: 100px; font-size: 10px">Household Goods:</label>
							...
							<div class="clear"></div>
							<!--- Insurance Boxes 1 --->
							<table width="237" border="0" cellspacing="0" cellpadding="0" class="noh" bgcolor="" style="    padding-bottom: 9px; margin-left: 76px !important;">
								<thead>
									<tr>
							...
							<div class="clear"></div>
							<!--- Insurance Boxes 2 --->
							<table width="315" border="0" cellspacing="0" cellpadding="0" class="noh" bgcolor="" style="padding-bottom:25px; margin-left: 32px !important;">
								<thead>
									<tr>
										<th width="5" align="left" valign="top"><img src="images/top-left.gif" alt="" width="5" height="23" /></th>
								...
								<tbody>
									<tr bgcolor="##f7f7f7" >
										...
										<td valign="middle" align="center">
											...
											<cfinput name="ExpirationDate" type="datefield" value="#Dateformat(variables.ExpirationDate,'mm/dd/yyyy')#" style="width:64px" onblur="checkDateFormatAll(this);"/>
										</td>
								    ...
								    <tr bgcolor="##FFFFFF">
										...
										<td valign="middle" align="center">
											<cfinput name="CARGOExpirationDate" type="datefield" value="#Dateformat(variables.CARGOExpirationDate,'mm/dd/yyyy')#" style="width:64px" onblur="checkDateFormatAll(this);"/>'
										</td>
										<td class="normal-td3">&nbsp;</td>
								    </tr>
									<!--- <tr bgcolor="##f7f7f7">
			...
			</cfif>  onchange="ParseUSNumber(this,'Office Phone #request.qCarrierOffice.currentRow#')" /></td>
			...
			</cfif>   onchange="ParseUSNumber(this,'Office Fax #request.qCarrierOffice.currentRow#')"/></td>
	           				<td class="normaltd2" valign="middle" align="left"><input name="office_Email#request.qCarrierOffice.currentRow#" class="td-textbox" type="text" value="#request.qCarrierOffice.EmailID#"  onchange="validateEmail(this,'Office Email #request.qCarrierOffice.currentRow#')"/></td>
	           				<td class="normal-td3">&nbsp;</td>
	           			  </tr>
		                 </cfloop>
		...
		<div class="carrier-mid" style="background-color: white;">
			...
			<div class="commodityWrap">
				<table id="tblrow"  class="noh" border="0" cellspacing="0" cellpadding="0" style="width:100%">
					<thead>
						<tr>
